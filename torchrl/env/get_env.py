...
def get_vec_env(
    env_id, env_param, vec_env_nums,
    single_env_func=get_single_env, device="cpu"
):
  vec_env = VecEnv(
...
def get_subprocvec_env(
    env_id, env_param, vec_env_nums, proc_nums,
    single_env_func=get_single_env, device="cpu"
):
  vec_env = SubProcVecEnv(
      proc_nums, vec_env_nums, single_env_func,
      [env_id, env_param])
  vec_env = TorchEnv(vec_env, device=device)
  vec_env = wrap_env(vec_env, env_param, device)
  return vec_env
